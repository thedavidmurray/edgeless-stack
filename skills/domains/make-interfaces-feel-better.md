...
description: UI polish: animations, typography, surfaces, motion, and micro-interactions.

metadata:
  tags: [ui, frontend, polish, animation, typography, surfaces, micro-interactions]
  tier: task-specific
  domain: creative
when_to_apply: When a frontend change needs polish, motion, typography, spacing, or interaction-detail refinement
---
...
| File | Purpose |
|------|---------|
| `typography.md` | Text wrapping, numeric alignment, font smoothing, and headline polish guidance |
| `surfaces.md` | Border radius, shadows, outlines, and tactile surface details |
| `animations.md` | Enter and exit motion, interruptible transitions, and icon animation details |
| `performance.md` | Transition-property discipline and `will-change` guidance for smooth UI behavior |
