...
description: >
  State-of-the-art text-to-image generation with Stable Diffusion models via
  HuggingFace Diffusers. Use when generating images from text prompts,
  performing image-to-image translation, inpainting, or building custom
  diffusion pipelines.
metadata:
  tags: [stable-diffusion, image-gen, diffusion, huggingface]
  tier: task-specific
  domain: creative
when_to_apply: >
  When generating images with Stable Diffusion via HuggingFace Diffusers.
---
