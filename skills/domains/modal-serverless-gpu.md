...
description: >
  ...
  on-demand GPU access without infrastructure management, deploying ML models as
  APIs, or running batch jobs with automatic scaling.
metadata:
  tags: [modal, serverless, gpu, cloud]
  tier: task-specific
  domain: tooling
