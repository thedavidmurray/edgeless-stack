...
name: comfyui
description: >
  Generate images, video, and audio with ComfyUI — install, launch, manage
  nodes/models, run workflows with parameter injection. Uses the official
  comfy-cli for lifecycle and direct REST/WebSocket API for execution.
metadata:
  tags: [comfyui, image-gen, video-gen, nodes, workflows]
  tier: task-specific
  domain: creative
when_to_apply: >
  When generating images, video, or audio with ComfyUI — install, manage
  nodes/models, run workflows.
---
