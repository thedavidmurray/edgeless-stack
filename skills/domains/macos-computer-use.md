...
description: >
  ...
  Works with any tool-capable model. Load this skill whenever the `computer_use`
  tool is available. version: 1.0.0 platforms: [macos] metadata: hermes: tags:
  [computer-use, macos, desktop, automation, gui] category: desktop
  related_skills: [browser]
metadata:
  tags: [macos, automation, screenshots, keyboard]
  tier: task-specific
  domain: tooling
when_to_apply: >
